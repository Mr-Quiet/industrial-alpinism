...
function initialize() {
    var mapOptions = {
      zoom: 14,
      center: new google.maps.LatLng(47.960939, 33.435439)
    };
...
var script = document.createElement('script');
    ...
    script.src='https://maps.googleapis.com/maps/api/js?key=AIzaSyAZdlwoxgra6lFbClGhHkHXQuWyvPW61fg&sensor=false&' +
        'callback=initialize';
